...
public class Data {
	...
	public static void main(String[] args) throws IOException {
		...
		double pruneFactor = 0.2;
		boolean wrong = false;
		
		System.out.println("\n----- Pruning Method One (Randomly Deleting Leaf Nodes) -----\n");
		
		do {
			System.out.println("Please input the factor p for pruning( 0 < p < 0.5 ): ");	
			pruneFactor = keyboard.nextDouble();
			if (pruneFactor <= 0 || pruneFactor > 0.5) {
				wrong = true;
		...
		DecisionTree.pruneTree(dt, dt.root, pruneFactor);
